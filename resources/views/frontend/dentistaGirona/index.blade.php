...
@section('content')
    ...
    <section class="pricing section-padding bg-cream">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p class="color-4">*** Barroso-Panella A., Lucas E., Lazaro A.<strong> Preservación, implante inmediato o protocolo diferido: toma de decisiones en el sector estético. </strong>Periodoncia Clínica 2016. </p>
                    <p class="color-4">*** Barroso-Panella A., Gargallo-Albiol J. Hernández-Alfaro F.<strong> Evaluation of bone stability and esthetic results after immediate implant placement using a novel synthetic bone substitue in the anterior zone: results after 12 months.</strong> Int JPeriodontics Restorative Dent 2018.<br><br>*** Barroso-Panella A., Ortiz-Puigpelat O., Altuna-Fistolera P., Lucas-Taulé E., Hernández-Alfaro F., Gargallo-Albiol J. <strong>Evaluation of periimplant tissue stability and patient's satisfaction after immediate implant placement in the aesthetic area. A 3-year follow-up study of an on-going prospective study. </strong>Int JPeriodontics Restorative Dent 2020.</p>
                </div>
            </div>
        </div>
    </section>
