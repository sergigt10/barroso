...
@section('content')
    ...
    <section class="pricing section-padding bg-cream">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p class="color-4">En el cas dels nens i preadolescents l'ortodòncia també permet modificar el creixement de maxilar i la mandíbula, especialment en nens que han adquirit mals hàbits com són la interposició lingual, la succió del dit, la respiració oral… Per això és molt important detectar aquests patrons de creixement incorrectes, ja que els tractaments a aquestes edats de creixement permet grans canvis tant a nivell facial com funcional, que en edat adulta poden ser molt més difícils de corregir.</p>
                    <p class="color-4"> L'ús de les noves tecnologies ens permet oferir tractaments més precisos i també una major comoditat pels pacients. Sabem que alguns procediments poden ser més molestos. Un d'ells són els motlles que prenem amb pastes de silicona per obtenir una rèplica amb guix de les dents. A Clinica Barroso fem un escaneig intraoral del pacient. L'escàner intraoral és un dispositiu electrònic que reprodueix les estructures de la cavitat oral amb imatges tridimensionals digitals. L'ús de l'escàner ofereix les següents avantatges:</p>
                    <p class="color-4">
                        · Més comoditat pel pacient, ja que s'eviten les molèsties causades per les mides de silicona evitant arcades i sensació d'ofec.<br>
                        · Ens permet ensenyar una imatge real i tridimensional de les dents.<br>
                        · El pacient pot visualitzar els canvis mitjançant una predicció virtual dels moviments de les seves dents.<br>
                        · Rapidesa a l'hora de realitzar els tractaments. Degut a que es treballen amb imatges podem enviar-les directament via internet al laboratori sense generar residus i transport de materials.
                    </p>
                    <div class="reservations mb-30">
                    </div>
                </div>
                <div class="col-md-12">
                    <p><b>Ortodòncia combinada amb estètica</b></p>
                    <p class="color-4">Alguns pacients no només busquen l'alineació de les seves dents si no també un canvi en la seva forma i color, és a dir, un canvi important en el seu somriure. En aquests casos combinem el tractament d'ortodòncia amb un tractament estètic, que ben poden ser les facetes dentals, corones estètiques o un simple emblanquiment dental al final del tractament.</p>
                    <p class="color-4">Els laminats són unes làmines que enganxem a la part de fora de les dents per tal d'obtenir el canvi estètic que volem. El fet de millorar la oclusió del pacient amb l'ortodòncia millorarà en moltes ocasions el pronòstic del tractament estètic, permetent mantenir més esmalt en les preparacions dentals i reduint el risc de fractures amb el temps.</p>
                </div>
                <div class="col-md-12 mt-15">
                    <div class="text-center">
                        <img src="{{ asset('frontend/img/ortodoncia-odontopediatria-girona.jpg') }}" alt="Clínica Barroso" class="width-80">
                        <br>
                        <p class="color-4">Recanvi de corones i facetes en mal estat, previ tractament d'ortodòncia</p>
                    </div>
                </div>
            </div>
        </div>
