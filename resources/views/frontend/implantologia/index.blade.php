...
@section('content')
    ...
    <section class="pricing section-padding bg-black" style="padding-bottom: 20px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p class="color-2">Els implants dentals han revolucionat l'odontologia dels últims 40 anys, permetent millorar la qualitat de vida de moltes persones. Permeten crear les bases per a substituir les dents originals i que les noves semblin, se sentin i funcionin com dents naturals.</p>
                    <p class="color-2">Les persones que han perdut dents, poden, gràcies als implants, menjar de tot, sabent que l'aparença natural de la seva boca es manté i que l'estètica facial es preserva.</p>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="text-center">
                        ...
                        <br>
                        <p class="color-4">Substitució de dent fracturada per un implant dental. Aspecte clínic després de 5 anys.</p>
                        <br><br>
                    </div>
                </div>
            </div>
