        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-left caption mt-90">
                    <h5>@lang("Emprova't el teu somriure")</h5>
                    <h1>@lang("Disseny de somriures")</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <span>@lang("<strong>Cas 1.</strong> Rehabilitació estètica amb una combinació de facetes ceràmiques, implants i fundes.")</span>
                </div>
                <div class="col-md-6">
                    <div class="beforeAfter">
                    ...
                    <span>@lang("<strong>Cas 2.</strong> Correcció del somriure invertit amb laminats ceràmics.")</span>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <span>@lang("<strong>Cas 3.</strong> Tractament d'ortodòncia de pacient amb un apinyament dental sever.")</span>
                </div>
                <div class="col-md-6">
                    <div class="beforeAfter">
                    ...
                    <span>@lang("<strong>Cas 4.</strong> Rehabilitació oral total amb pròtesis fixes sobre implants dentals.")</span>
                </div>
            </div>
        </div>
    </section>
