...
@section('content')
    ...
    <section class="pricing section-padding bg-cream">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p class="color-4">@lang("En moltes ocasions la realització de procediments mínimament invasius, els quals requereixen un bon entrenament i un alt grau d'especialització, ens permetran assolir aquests objectius amb més facilitat, a la vegada que disminuirà moltíssim el desconfort postoperatori del pacient i el temps total de tractament. Així ho hem demostrat en algunes publicacions científiques escrites pel Dr. Albert Barroso i publicades en revistes internacionals.")</p>
                    <p class="color-4">@lang("Estem compromesos en la realització dels tractaments més efectius i que provoquin les mínimes molèsties post-operatòries, compaginat a la vegada amb un treball constant de recerca en el camp de la implantologia estètica.")<br><br> 
                    @lang("Paral.lelament a l'atenció dels pacients a la clínica, el Dr. Albert Barroso realitza tasques d'investigació relacionades amb la implantologia de la qual se n'han derivat diverses publicacions científiques internacionals. *** Compartir els resultats d'aquestes investigacions ha sigut motiu de presentacions tant en congressos nacionals com internacionals.")<br><br>
                    @lang("A part, imparteix docència a la facultat d'odontologia i en cursos de formació continuada.")</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <p style="font-size: 15px;">@lang("*** articles publicats pel Dr. Albert Barroso")</p>
